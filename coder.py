...
class DictionnaireOrdonne:
	...
	def __setitem__(self, cle, valeur):
		"""Méthode spéciale quand on cherche à modifier une clé
	...
	def reverse(self):
		...
		# On crée deux listes vides qui contiennent le nouvel ordre des clés
		# et valeurs
		cles = []
		valeurs = []
		for cle, valeur in self.items():
	...
	def sort(self):
		"""Méthode premettant de trier le dictionnaire en fonction de ses clés"""
		# On trie les clés
